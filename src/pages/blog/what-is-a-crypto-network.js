  ...
  return (
    <Layout>
      ...
      <div>
        ...
        <Dates>Published 2021-03-19 &nbsp;&middot;&nbsp; Updated 2021-03-27</Dates>
        <p>A crypto network is a social coordination technology that provides participants a <i>shared language for representing value and data</i> in a <i>trust-minimized environment</i> using strong cryptography and a consensus mechanism.</p>
        ...
        <p>"Crypto network" can also be applied to institutions using different layers of abstraction. For example, I can call both Ethereum mainnet (the blockchain where most smart contract activity is currently taking place) and Uniswap (currently the most active decentralized exchange on Ethereum) crypto networks, even though Uniswap's back-end is a set of smart contracts deployed to Ethereum, so it is a subset of the Ethereum network. Some major projects in crypto don't use a blockchain at all -- IPFS, IOTA, etc. The shared mechanism between these networks is cryptography, which allows for anyone to wield information asymmetricly and prove one's identity by the power of mathematics.</p>
        <p>Crypto networks surpass mere "blockchain technology" in scope and importance because they challenge the way we percieve socioeconomic concepts like value, trust, and scarcity. They are one of the most significant inventions of the Information Age as they disintermediate our very representations of value.</p>
      </div>
    </Layout>
  )
}
